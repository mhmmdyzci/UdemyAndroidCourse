package com.mhmmdyzci.artbookjava;
...
import com.mhmmdyzci.artbookjava.databinding.ActivityArtBinding;
...
public class ArtActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (info.matches("new")) {
            ...
            Bitmap selectImage = BitmapFactory.decodeResource(getApplicationContext().getResources(),R.drawable.aaaa);
